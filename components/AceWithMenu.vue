...
export default defineComponent({
  ...
  setup() {
    ...
    const showFilterDialog1 = () => {
      filterDialogVisible.value = true;
      filterTitle.value = "筛选/过滤 包含特定文本的行"
    };
    const showFilterDialog2 = () => {
      filterDialogVisible.value = true;
      filterTitle.value = "筛选/过滤 不包含特定文本的行"
    };
    const menuData = ref([
      {
        "name": "筛选/过滤",
    ...
    const filterTitle = ref("筛选/过滤 包含特定文本的行");
    const easyMode = ref(false);
    const editerTxt = ref(`console.log('Hello, Ace Editor!');xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
1
2
3
4
...
.wrapper {
  ...
  border-radius: 8px;
    ...
    const filterStrFun = () => {
      ...
      if (filterTitle.value == "筛选/过滤 包含特定文本的行") {
...
<template>
  ...
  <div>
    ...
    <el-dialog v-model="filterDialogVisible" :modal="searchDialogModal" :close-on-click-modal="false"
      ...
      :title="filterTitle" @focusin="searchDialogFocus('open')" @focusout="searchDialogFocus('close')"
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="danger" @click="filterStrFun()"> 确定 </el-button>
        </div>
      </template>
    </el-dialog>
